/**************************************************************
 * IndexedCube:  A class that creates a cube in a variety 
 * of ways.
 * Create 08/2020 by Edward C. Eberle <eberdeed@eberdeed.net>
 * San Diego, California USA
 *************************************************************/

#include "../include/indexedcube.h"
...
float *IndexedCube::genCube(float scale, bool colored, bool normaled, bool textured)
{
...
float *IndexedCube::getCube()
{
    return cubeVerts;
}

float *IndexedCube::getColor()
{
    return cubeColors;
}

float *IndexedCube::getNormals()
{
    return cubeNormals;
}

float *IndexedCube::getTexCoords()
{
    return cubeTex;
}

unsigned int *IndexedCube::getIndices()
{
    return cubeIndices;
}

void IndexedCube::genMatrices()
{
...
vec2 IndexedCube::genTexture(vec3 normal, vec3 triangle)
{
