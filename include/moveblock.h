...
/** \class MoveBlock  A class that uses OpenGL Transformation Feedback
 * to translate and scale an object and draw it to the screen.
 */
class MoveBlock  
{
public: 
    ...
    void update(vec3 movement, float deltaTime);
    ...
    //! Orientation for rotation. (Not used.)
    const mat4 orientation = mat4(1.0f);
